...
const sectionTextSchema = new mongoose_1.Schema({
    heading: {
        type: String,
...
const SectionText = mongoose_1.default.model("SectionText", sectionTextSchema);
exports.default = SectionText;
//# sourceMappingURL=section-text.model.js.map