...
const TopNavigation = () => {
    ...
    <header className=" fixed pt-2 top-0 left-0 right-0 z-50 h-14 flex w-full items-center justify-between border-b border-gray-200 bg-blue-700 p-2 ">
        ...
        <div className="flex items-center space-x-2">
            <button type="button" className="text-3xl asideOpen" ><i className="bx bx-menu"></i></button>
        ...
        <div className="min-h-screen flex items-center justify-center ">
            <div className="relative group">
                ...
                <div id="dropdown-menu" className={`${centerMenuOpen ? '':'hidden'} absolute right-0 mt-2 rounded-md shadow-lg bg-blue-500 ring-1 ring-black ring-opacity-5 p-1 space-y-1`}>
                {/* <!-- Dropdown content goes here --> */}
                <a href="#" className="text-white text-sm block p-5 px-z py-2 hover:bg-blue-300 active:bg-blue-100 cursor-pointer rounded-md">Manage Portfolios</a>
                <a href="#" className="text-white text-sm block p-5 px-4 py-2 hover:bg-blue-300 active:bg-blue-100 cursor-pointer rounded-md">Yours</a>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <button 
                ...
                >
                <img src={loginUser.img} alt="plchldr.co" />
            </button>

            {/* menu hidden/show */}
            <div className={`${rightMenuOpen? '':'hidden'} absolute right-2 mt-1 w-48 divide-y divide-gray-200 rounded-md border border-gray-200 bg-white shadow-md`}
                x-show="profileOpen" x-transition>
                <div className="flex items-center space-x-2 p-2">
                    <img src={loginUser.img} alt="plchldr.co" className="h-9 w-9 rounded-full" />
                ...
                <div className="flex flex-col space-y-3 p-2">
                    ...
                    <a href="../login" className="text-sm ransition hover:text-blue-600">Login</a>
