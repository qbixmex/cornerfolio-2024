                ...
                <div className="relative group">
                    ...
                    >
                        ...
                        <svg
                            ...
                            aria-hidden="true"
                        >
                            <path clipRule="evenodd" d="M6.293 9.293a1 1 0 011.414 0L10 11.586l2.293-2.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" />
                        </svg>
                    </button>

                    <div
                        id="dropdown-menu"
                        className={`${centerMenuOpen ? '' : 'hidden'} absolute right-0 mt-2 rounded-md shadow-lg bg-blue-500 ring-1 ring-black ring-opacity-5 p-1 space-y-1`}
                    >
