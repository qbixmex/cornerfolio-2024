	...
	return (
		<div className="flex justify-around w-full">
			<Button
				...
				size="sm"
				className={`
						border bg-gradient-to-tl from-purple-700 to-sky-500 hover:bg-gray-200 flex justify-center self-center rounded-md h-8 w-9 mb-3`}
			...
			<Button
				...
				size="sm"
				className={`
						border bg-gradient-to-tl from-purple-300 to-sky-500 hover:bg-gray-200 flex justify-center self-center rounded-md h-8 w-9 mb-3`}
